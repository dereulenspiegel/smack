 ...
 * hold any references in memory on its own so it is neccesary to keep a
...
public class ChatManager {
	...
	/**
	 * Try to get a matching chat for the given user JID. Try the full JID map
	 * first, the try to match on the base JID if no match is found.
	 * 
	 * @param userJID
	 * @return
	 */
